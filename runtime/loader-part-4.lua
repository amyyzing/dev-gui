...
function buildPage2()
	...
	local page2Ctx={
		...
		State={},
		Bindings={
			{label="Toggle open / hide GUI",description="Show or hide the entire GUI.",get=function() return TOGGLE_UI_KEY end,set=function(v) TOGGLE_UI_KEY=v; requestPlayerAutosave() end},
			{label="Hitbox Toggle",description="Enable or disable hitbox edits.",get=function() return TOGGLE_HB_KEY end,set=function(v) TOGGLE_HB_KEY=v; requestPlayerAutosave() end},
			{label="Jump Boost Toggle",description="Turn jump boost on or off.",get=function() return TOGGLE_JB_KEY end,set=function(v) TOGGLE_JB_KEY=v; requestPlayerAutosave() end},
			{label="Always Boost Toggle",description="Switch always boost behavior.",get=function() return TOGGLE_AB_KEY end,set=function(v) TOGGLE_AB_KEY=v; requestPlayerAutosave() end},
			{label="ESP Toggle",description="Toggle receiver and coverage overlays.",get=function() return TOGGLE_ACTION_KEY end,set=function(v) TOGGLE_ACTION_KEY=v; requestPlayerAutosave() end},
			{label="Speed Toggle",description="Toggle forced player speed.",get=function() return TOGGLE_SPEED_KEY end,set=function(v) TOGGLE_SPEED_KEY=v; requestPlayerAutosave() end},
			{label="QB Aim Lock Receiver",description="Lock the receiver under your cursor.",get=function() return QB_AIM_LOCK_KEY end,set=function(v) QB_AIM_LOCK_KEY=v; requestPlayerAutosave() end},
			{label="QB Aim Throw",description="Throw to the locked receiver.",get=function() return QB_AIM_THROW_KEY end,set=function(v) QB_AIM_THROW_KEY=v; requestPlayerAutosave() end},
			{label="QB Aim Toggle",description="Enable or disable QB aim assist.",get=function() return QB_AIM_TOGGLE_KEY end,set=function(v) QB_AIM_TOGGLE_KEY=v; requestPlayerAutosave() end},
		},
	}
