...
UILibVisualModule={
	...
	Theme={BG=Color3.fromRGB(18,20,26),TOPBAR=Color3.fromRGB(22,25,32),PANEL=Color3.fromRGB(24,28,36),CARD=Color3.fromRGB(29,34,44),SECTION=Color3.fromRGB(27,31,40),BUTTON=Color3.fromRGB(31,39,52),INPUT=Color3.fromRGB(19,23,31),SLIDER_BG=Color3.fromRGB(19,24,34),SLIDER_FILL=Color3.fromRGB(0,145,255),STROKE_SOFT=Color3.fromRGB(47,56,74),TEXT=Color3.fromRGB(235,242,255),MUTED=Color3.fromRGB(142,156,178)},
	Shape={WindowRadius=4,SectionRadius=4,ControlRadius=4,SliderRadius=4,SliderHeight=28,SliderStyle="pill",WindowStrokeTransparency=0.36,SectionStrokeTransparency=0.78,ControlStrokeTransparency=0.72,SliderStrokeTransparency=0.72,AccentStrokeTransparency=0.46},
	Components={TextFont=Enum.Font.Gotham,TitleFont=Enum.Font.GothamBold,ControlFont=Enum.Font.GothamMedium,SectionPrefix=false,SectionPaddingX=14,SectionPaddingY=12,SectionGap=7,SectionHeaderHeight=22,SectionTitleSize=14,SectionSubtitleSize=11,SectionBackgroundTransparency=0,SectionStrokeTransparency=0.78,SectionBodyInset=0,SectionBodyGap=7,SliderLabelPlacement="above",SliderRowHeight=52,SliderTrackWidth=220,SliderLabelWidth=112,SliderLabelHeight=14,SliderLabelY=3,SliderControlGap=5,SliderBottomPadding=7,SliderTrackGap=10,SliderValueBoxWidth=54,SliderValueBoxGap=6,SliderValueBoxHeight=28,SliderValueBoxVisible=true,SliderContainerTransparency=0.06,SliderContainerStrokeTransparency=0.72,SliderTrackStrokeTransparency=0.84,SliderValueBoxStrokeTransparency=0.86,SliderLabelX=12,SliderRightPadding=8,ToggleWidth=52,ToggleHeight=22,ToggleKnobSize=16,TogglePad=3,ToggleStyle="switch",ToggleOffRole="INPUT",ToggleStrokeTransparency=0.72,TextBoxHeight=30,ButtonHeight=32,ControlStrokeTransparency=0.72},
	MainFrame={Window={W=760,H=540,MinW=560,MinH=380,MaxW=1220,MaxH=820,StartY=76,MinimizedH=64},Layout={RootPadding=6,MainGap=8,PageGap=8,ColumnGap=8,FooterGap=8,HeaderHeight=58,PageBarHeight=36,PageTabWidth=104,PageTabHeight=30,PageHostReserve=154,FooterHeight=34,TopButtonSize=30,TopButtonGap=6,TopButtonOuter=10,FabSize=42,NavPlacement="left",NavWidth=150,NavGap=8,NavTabGap=6,NavTabPad=8,NavTabInset=8,PageShellTransparency=0,PageSliderTransparency=0}},
	Tones={topbar=0.04,panel=0.07,card=0.11,section=0.09,button=0.14,input=-0.02,sliderBg=-0.05,strokeSoft=0.28},
}
UILibRayfieldModule={
	Id="rayfield",
	Name="Rayfield",
	...
	Theme={BG=Color3.fromRGB(25,25,25),TOPBAR=Color3.fromRGB(34,34,34),PANEL=Color3.fromRGB(30,30,30),CARD=Color3.fromRGB(35,35,35),SECTION=Color3.fromRGB(35,35,35),BUTTON=Color3.fromRGB(35,35,35),INPUT=Color3.fromRGB(30,30,30),SLIDER_BG=Color3.fromRGB(43,105,159),SLIDER_FILL=Color3.fromRGB(43,105,159),STROKE_SOFT=Color3.fromRGB(55,55,55),TEXT=Color3.fromRGB(240,240,240),MUTED=Color3.fromRGB(178,178,178)},
	Shape={WindowRadius=8,SectionRadius=8,ControlRadius=10,SliderRadius=10,SliderHeight=30,SliderStyle="rayfield",WindowStrokeTransparency=0.48,SectionStrokeTransparency=0.8,ControlStrokeTransparency=0.78,SliderStrokeTransparency=0.78,AccentStrokeTransparency=0.62},
	Components={TextFont=Enum.Font.Gotham,TitleFont=Enum.Font.GothamBold,ControlFont=Enum.Font.GothamMedium,SectionPrefix=false,SectionPaddingX=14,SectionPaddingY=12,SectionGap=8,SectionHeaderHeight=21,SectionTitleSize=13,SectionSubtitleSize=11,SectionBackgroundTransparency=0,SectionStrokeTransparency=0.82,SectionBodyInset=0,SectionBodyGap=8,SliderLabelPlacement="above",SliderRowHeight=54,SliderTrackWidth=224,SliderLabelWidth=108,SliderLabelHeight=14,SliderLabelY=4,SliderControlGap=5,SliderBottomPadding=7,SliderTrackGap=12,SliderValueBoxWidth=52,SliderValueBoxGap=10,SliderValueBoxHeight=28,SliderValueBoxVisible=true,SliderContainerTransparency=0.04,SliderContainerStrokeTransparency=0.8,SliderTrackStrokeTransparency=0.82,SliderValueBoxStrokeTransparency=0.9,SliderLabelX=14,SliderRightPadding=10,ToggleWidth=54,ToggleHeight=24,ToggleKnobSize=18,TogglePad=3,ToggleStyle="pill",ToggleOffRole="INPUT",ToggleStrokeTransparency=0.82,TextBoxHeight=30,ButtonHeight=32,ControlStrokeTransparency=0.78},
	MainFrame={Window={W=500,H=480,MinW=420,MinH=360,MaxW=900,MaxH=760,StartY=80,MinimizedH=60},Layout={RootPadding=0,MainGap=8,PageGap=8,ColumnGap=8,FooterGap=8,HeaderHeight=46,PageBarHeight=42,PageTabWidth=94,PageTabHeight=30,PageHostReserve=142,FooterHeight=34,TopButtonSize=28,TopButtonGap=6,TopButtonOuter=10,FabSize=42,PageShellTransparency=0.03,PageSliderTransparency=0}},
	Tones={topbar=0.08,panel=0.04,card=0.10,section=0.10,button=0.10,input=0.04,sliderBg=0.04,sliderAccent=true,sliderBlend=0.45,strokeSoft=0.24},
}
UILibWindUIModule={
	Id="windui",
	Name="WindUI",
...
UILibLinoriaModule={
	...
	Style={Primary=Color3.fromRGB(18,18,18),Stroke=Color3.fromRGB(77,255,82),Gradient=Color3.fromRGB(55,203,255),GradientOn=true,StrokeThickness=1,StrokeTransparency=0.62},
	Theme={BG=Color3.fromRGB(16,16,16),TOPBAR=Color3.fromRGB(18,18,18),PANEL=Color3.fromRGB(20,20,20),CARD=Color3.fromRGB(22,22,22),SECTION=Color3.fromRGB(18,18,18),BUTTON=Color3.fromRGB(25,25,25),INPUT=Color3.fromRGB(16,16,16),SLIDER_BG=Color3.fromRGB(28,28,28),SLIDER_FILL=Color3.fromRGB(77,255,82),STROKE_SOFT=Color3.fromRGB(70,70,70),TEXT=Color3.fromRGB(245,245,245),MUTED=Color3.fromRGB(185,185,185)},
	Shape={WindowRadius=3,SectionRadius=2,ControlRadius=2,SliderRadius=2,SliderHeight=22,SliderStyle="thin",WindowStrokeTransparency=0.26,SectionStrokeTransparency=0.36,ControlStrokeTransparency=0.38,SliderStrokeTransparency=0.42,AccentStrokeTransparency=0.42},
	Components={TextFont=Enum.Font.Code,TitleFont=Enum.Font.Code,ControlFont=Enum.Font.Code,SectionPrefix=false,SectionPaddingX=8,SectionPaddingY=7,SectionGap=4,SectionHeaderHeight=18,SectionTitleSize=13,SectionSubtitleSize=10,SectionBackgroundTransparency=0,SectionStrokeTransparency=0.36,SectionBodyInset=0,SectionBodyGap=4,SliderLabelPlacement="above",SliderRowHeight=42,SliderTrackWidth=210,SliderLabelWidth=116,SliderLabelHeight=12,SliderLabelY=2,SliderControlGap=2,SliderBottomPadding=4,SliderValueBoxWidth=48,SliderValueBoxGap=5,SliderValueBoxHeight=20,SliderValueBoxVisible=true,SliderContainerTransparency=1,SliderContainerStrokeTransparency=1,SliderTrackStrokeTransparency=0.42,SliderValueBoxStrokeTransparency=0.42,SliderLabelX=8,SliderRightPadding=6,ToggleWidth=42,ToggleHeight=18,ToggleKnobSize=14,TogglePad=2,ToggleStyle="block",ToggleOffRole="INPUT",ToggleStrokeTransparency=0.38,TextBoxHeight=24,ButtonHeight=26,ControlStrokeTransparency=0.38},
	MainFrame={Window={W=760,H=560,MinW=560,MinH=380,MaxW=1120,MaxH=760,StartY=70,MinimizedH=54},Layout={RootPadding=6,MainGap=6,PageGap=6,ColumnGap=6,FooterGap=6,HeaderHeight=42,PageBarHeight=28,PageTabWidth=92,PageTabHeight=24,PageHostReserve=120,FooterHeight=28,TopButtonSize=24,TopButtonGap=4,TopButtonOuter=8,FabSize=36,PageShellTransparency=0,PageSliderTransparency=0}},
	Tones={topbar=0.04,panel=0.07,card=0.10,section=0.06,button=0.13,input=0.02,sliderBg=0.11,strokeSoft=0.25},
}
UILibObsidianModule={
	Id="obsidian",
	Name="Obsidian",
	...
	Style={Primary=Color3.fromRGB(15,15,20),Stroke=Color3.fromRGB(145,88,255),Gradient=Color3.fromRGB(230,92,255),GradientOn=true,StrokeThickness=1,StrokeTransparency=0.76},
	...
	Shape={WindowRadius=7,SectionRadius=4,ControlRadius=4,SliderRadius=3,SliderHeight=24,SliderStyle="glow",WindowStrokeTransparency=0.52,SectionStrokeTransparency=0.78,ControlStrokeTransparency=0.72,SliderStrokeTransparency=0.72,AccentStrokeTransparency=0.52},
	Components={TextFont=Enum.Font.Code,TitleFont=Enum.Font.GothamMedium,ControlFont=Enum.Font.Code,SectionPrefix=false,SectionPaddingX=12,SectionPaddingY=10,SectionGap=6,SectionHeaderHeight=20,SectionTitleSize=13,SectionSubtitleSize=10,SectionBackgroundTransparency=0,SectionStrokeTransparency=0.78,SectionBodyInset=0,SectionBodyGap=6,SliderLabelPlacement="above",SliderRowHeight=48,SliderTrackWidth=212,SliderLabelWidth=120,SliderLabelHeight=14,SliderLabelY=3,SliderControlGap=5,SliderBottomPadding=7,SliderValueBoxWidth=54,SliderValueBoxGap=8,SliderValueBoxHeight=26,SliderValueBoxVisible=true,SliderContainerTransparency=0.18,SliderContainerStrokeTransparency=0.86,SliderTrackStrokeTransparency=0.78,SliderValueBoxStrokeTransparency=0.82,SliderLabelX=10,SliderRightPadding=8,ToggleWidth=52,ToggleHeight=22,ToggleKnobSize=16,TogglePad=3,ToggleStyle="block",ToggleOffRole="INPUT",ToggleStrokeTransparency=0.72,TextBoxHeight=30,ButtonHeight=30,ControlStrokeTransparency=0.72},
	MainFrame={Window={W=735,H=560,MinW=560,MinH=380,MaxW=1120,MaxH=780,StartY=72,MinimizedH=58},Layout={RootPadding=4,MainGap=6,PageGap=8,ColumnGap=8,FooterGap=6,HeaderHeight=50,PageBarHeight=34,PageTabWidth=96,PageTabHeight=30,PageHostReserve=142,FooterHeight=34,TopButtonSize=30,TopButtonGap=6,TopButtonOuter=8,FabSize=40,NavPlacement="left",NavWidth=160,NavGap=8,NavTabGap=6,NavTabPad=8,NavTabInset=8,PageShellTransparency=0,PageSliderTransparency=0}},
