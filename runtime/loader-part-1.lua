...
UILibLinoriaModule={
	...
	MainFrame={Window={W=760,H=560,MinW=560,MinH=380,MaxW=1120,MaxH=760,StartY=70,MinimizedH=48},Layout={RootPadding=6,MainGap=4,PageGap=6,ColumnGap=6,FooterGap=6,HeaderHeight=30,PageBarHeight=26,PageTabWidth=92,PageTabHeight=22,PageHostReserve=108,FooterHeight=28,TopButtonSize=22,TopButtonGap=4,TopButtonOuter=8,FabSize=36,PageShellTransparency=0,PageSliderTransparency=0}},
