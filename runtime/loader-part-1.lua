...
UILibVisualModule={
	...
	Components={TextFont=Enum.Font.Gotham,TitleFont=Enum.Font.GothamBold,ControlFont=Enum.Font.GothamMedium,SectionPrefix=false,SectionPaddingX=14,SectionPaddingY=12,SectionGap=7,SectionHeaderHeight=22,SectionTitleSize=14,SectionSubtitleSize=11,SectionBackgroundTransparency=0,SectionStrokeTransparency=0.78,SectionBodyInset=0,SectionBodyGap=7,SliderRowHeight=38,SliderTrackWidth=220,SliderLabelWidth=126,SliderValueBoxWidth=58,SliderValueBoxVisible=true,SliderContainerTransparency=0,SliderContainerStrokeTransparency=0.72,SliderLabelX=12,SliderRightPadding=8,ToggleWidth=52,ToggleHeight=22,ToggleKnobSize=16,TogglePad=3,ToggleStyle="switch",ToggleOffRole="INPUT",ToggleStrokeTransparency=0.72,TextBoxHeight=30,ButtonHeight=32,ControlStrokeTransparency=0.72},
...
UILibRayfieldModule={
	...
	Components={TextFont=Enum.Font.Gotham,TitleFont=Enum.Font.GothamBold,ControlFont=Enum.Font.GothamMedium,SectionPrefix=false,SectionPaddingX=14,SectionPaddingY=12,SectionGap=8,SectionHeaderHeight=21,SectionTitleSize=13,SectionSubtitleSize=11,SectionBackgroundTransparency=0,SectionStrokeTransparency=0.82,SectionBodyInset=0,SectionBodyGap=8,SliderRowHeight=40,SliderTrackWidth=224,SliderLabelWidth=124,SliderValueBoxWidth=56,SliderValueBoxVisible=true,SliderContainerTransparency=0,SliderContainerStrokeTransparency=0.8,SliderLabelX=14,SliderRightPadding=10,ToggleWidth=54,ToggleHeight=24,ToggleKnobSize=18,TogglePad=3,ToggleStyle="pill",ToggleOffRole="INPUT",ToggleStrokeTransparency=0.82,TextBoxHeight=30,ButtonHeight=32,ControlStrokeTransparency=0.78},
...
UILibLinoriaModule={
	...
	Components={TextFont=Enum.Font.Code,TitleFont=Enum.Font.Code,ControlFont=Enum.Font.Code,SectionPrefix=false,SectionPaddingX=8,SectionPaddingY=7,SectionGap=4,SectionHeaderHeight=18,SectionTitleSize=13,SectionSubtitleSize=10,SectionBackgroundTransparency=0,SectionStrokeTransparency=0.36,SectionBodyInset=0,SectionBodyGap=4,SliderRowHeight=28,SliderTrackWidth=210,SliderLabelWidth=116,SliderValueBoxWidth=54,SliderValueBoxVisible=true,SliderContainerTransparency=0,SliderContainerStrokeTransparency=0.45,SliderLabelX=8,SliderRightPadding=6,ToggleWidth=42,ToggleHeight=18,ToggleKnobSize=14,TogglePad=2,ToggleStyle="block",ToggleOffRole="INPUT",ToggleStrokeTransparency=0.38,TextBoxHeight=24,ButtonHeight=26,ControlStrokeTransparency=0.38},
...
UILibObsidianModule={
	...
	Components={TextFont=Enum.Font.Code,TitleFont=Enum.Font.GothamMedium,ControlFont=Enum.Font.Code,SectionPrefix=false,SectionPaddingX=12,SectionPaddingY=10,SectionGap=6,SectionHeaderHeight=20,SectionTitleSize=13,SectionSubtitleSize=10,SectionBackgroundTransparency=0,SectionStrokeTransparency=0.78,SectionBodyInset=0,SectionBodyGap=6,SliderRowHeight=34,SliderTrackWidth=212,SliderLabelWidth=120,SliderValueBoxWidth=58,SliderValueBoxVisible=true,SliderContainerTransparency=0,SliderContainerStrokeTransparency=0.72,SliderLabelX=10,SliderRightPadding=8,ToggleWidth=52,ToggleHeight=22,ToggleKnobSize=16,TogglePad=3,ToggleStyle="block",ToggleOffRole="INPUT",ToggleStrokeTransparency=0.72,TextBoxHeight=30,ButtonHeight=30,ControlStrokeTransparency=0.72},
