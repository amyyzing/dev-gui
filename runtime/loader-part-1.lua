...
UILibRayfieldModule={
	...
	Components={TextFont=Enum.Font.Gotham,TitleFont=Enum.Font.GothamBold,ControlFont=Enum.Font.GothamMedium,SectionPrefix=false,SectionPaddingX=14,SectionPaddingY=12,SectionGap=8,SectionHeaderHeight=21,SectionTitleSize=13,SectionSubtitleSize=11,SectionBackgroundTransparency=0,SectionStrokeTransparency=0.82,SectionBodyInset=0,SectionBodyGap=8,SliderRowHeight=40,SliderTrackWidth=224,SliderValueBoxWidth=56,SliderValueBoxVisible=true,SliderContainerTransparency=0,SliderContainerStrokeTransparency=0.8,SliderLabelX=14,SliderRightPadding=10,ToggleWidth=54,ToggleHeight=24,ToggleKnobSize=18,TogglePad=3,ToggleStyle="pill",ToggleOffRole="INPUT",ToggleStrokeTransparency=0.82,TextBoxHeight=30,ButtonHeight=32,ControlStrokeTransparency=0.78},
