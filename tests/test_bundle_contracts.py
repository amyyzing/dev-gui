...
class BundleContracts(unittest.TestCase):
    ...
    def test_normal_loader_uses_main_credentials_and_reexecution_cleanup(self):
        ...
        self.assertIn("fresh=fresh", loader)
        self.assertIn("sharedEnv.GUI_BOOT_CONFIG=config", loader)
        self.assertIn("sharedEnv.GUI_BOOT_CONFIG=previousBootConfig", loader)
