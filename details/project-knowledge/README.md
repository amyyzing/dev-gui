...
- `Lead Adjust` is direct receiver prediction time. The current default is `0.20`, and the solver advances the receiver by `wrVel * (releaseOffset + WR_LEAD_DELAY)` before root solving.
